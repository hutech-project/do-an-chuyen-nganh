        ...
        <div id="main-wrapper">
          <div class="row">
            <div class="col-sm-4">
                ...
                <img src="<?php echo base_url()."public/$module/images/hotel2.jpg"?>" alt="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="image-wrapper">
                  <img src="<?php echo base_url()."public/$module/images/hotel3.jpg"?>" alt="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="image-wrapper">
                  <img src="<?php echo base_url()."public/$module/images/hotel4.jpg"?>" alt="">
                </div>
            </div>
          </div>
